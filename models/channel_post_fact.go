...
type ChannelPostFact struct {
	...
	// Часы: 7–24 → 31.9–39.4%
	View724HourFact float64 `json:"view_7_24hour_fact"`
	// Часы: 4–6 → 14.9–19.4%
	View46HourFact float64 `json:"view_4_6hour_fact"`
	// Часы: 2–3 → 17.2–21.7%
	View23HourFact float64 `json:"view_2_3hour_fact"`
	// Часы: 1 → 20.6–25.7%
	View1HourFact      float64 `json:"view_1hour_fact"`
